...
(function (plugins) {
    ...
    (function (dreamline) {
        let admin;
        (function (admin) {
            class Dreamline extends modules.admin.admin.Component {
                /**
                 * 플러그인 환경설정 폼을 가져온다.
                 *
            ...
            admin.Dreamline = Dreamline;
        })(admin = dreamline.admin || (dreamline.admin = {}));
    })(dreamline = plugins.dreamline || (plugins.dreamline = {}));
})(plugins || (plugins = {}));
